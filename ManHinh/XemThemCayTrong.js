        ...
        <ScrollView>
            <View style={styles.container}>
                <View style={styles.header}>
                    ...
                    <Text style={{ textAlign: 'center', fontSize: 18, fontWeight: 'bold' }}>SamSung</Text>
                ...
                <View style={{ flexDirection: 'row', gap: 30, marginHorizontal: 5 }}>
                    ...
                    <Text style={{ color:color3? 'red':null }}>SamSung A</Text>
                    </TouchableOpacity>
                    <TouchableOpacity onPress={()=>{
                        setcolor1(false)
                        setcolor2(false)
                    ...
                    <Text style={{ color:color4? 'red':null }}>SamSung Galaxy</Text>
                    </TouchableOpacity>
                </View>
                <FlatList
                    numColumns={2}
