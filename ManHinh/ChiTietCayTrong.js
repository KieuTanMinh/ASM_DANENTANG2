  ...
  return (
    <ScrollView>
      ...
      <View style={{margin:10}}>
        {item.type?<Text style={{fontSize:20,backgroundColor:'green',color:'white',width:120,textAlign:'center',padding:5,borderRadius:10}}>Sản Phẩm</Text>:<Text style={{fontSize:20,backgroundColor:'green',color:'white',width:120,textAlign:'center',padding:5,borderRadius:10}}>Reno11 5G</Text>}
      </View>
